...
// -*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-<Transporte>-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
// Todas as informações necessarias para o transporte em uma emissao de nota

Schema.freteSchema = new SimpleSchema({
  ...
  transportador:{
    type: Schema.transportadorSchema,
    optional: true,
    autoform:{
      // group: "transportador"
    }
...
Schema.transportadorSchema = new SimpleSchema({
  ...
  "transportador.endereco.logradouro":{
    type: String,
    optional: true,
    autoform:{
      // group:"endereco",
  ...
  "transportador.endereco.municipio":{
      type: Number,
      optional: true,
      autoform:{
        // group:"endereco",
...
Schema.retencaoSchema = new SimpleSchema({
...
Schema.veiculoSchema = new SimpleSchema({
  //Veiculo ou reboque
  placa:{
    type: String,
    optional: true
...
Schema.volumeSchema= new SimpleSchema({
...
Schema.tributosSchema = new SimpleSchema({
  ...
  icms:{
    type: Schema.icmsSchema,
    optional: true
  },
  issqn:{
    type: Schema.issqnSchema,
    optional: true
  },
...
// guia ICMS
Schema.icmsTributoSchema = new SimpleSchema({
    regime:{
      type: String,
      optional: true
    },
    ...
    simplesnacional:{
      type: Schema.simplesnacionalSchema,
      optional: true
    }

});

Schema.simplesnacionalSchema = new SimpleSchema({
  situacaotributaria:{
    type: String,
    optional: true
  },
...
Schema.icmsstSchema = new SimpleSchema({
...
Schema.icmsSchema = new SimpleSchema({
...
// guia IPI
Schema.ipiTributoSchema = new SimpleSchema({
  situacaotributaria:{
    type: String,
    optional: true
  },
...
// guia PIS
Schema.pisTributoSchema = new SimpleSchema({
  pis:{
    type: Schema.pisSchema,
    optional: true
  },
  pisst:{
    type: Schema.pisstSchema,
    optional: true
  },

});

Schema.pisSchema = new SimpleSchema({
  situacaotributaria:{
    type: String,
    optional: true
  },
...
Schema.pisstSchema = new SimpleSchema({
...
// guia COFINS
Schema.cofinsTributoSchema = new SimpleSchema({
  cofins:{
    type: Schema.cofinsSchema,
    optional: true
  },
  cofinsst:{
    type: Schema.cofinsstSchema,
    optional: true
  },

});

Schema.cofinsSchema = new SimpleSchema({
  situacaotributaria:{
    type: String,
    optional: true
  },
...
Schema.cofinsstSchema = new SimpleSchema({
...
// guia Imposto de Importação
Schema.importacaoTributoSchema = new SimpleSchema({
...
// guia ISSQN
Schema.issqnTributoSchema = new SimpleSchema({
});

// guia IPI Devolvido
Schema.ipidevolvidoTributoSchema = new SimpleSchema({
  percentualdevolvido:{
    type: String,
    optional: true
  },
...
// guia ICMS em operações interestaduais
Schema.icmsinterestatualTributoSchema = new SimpleSchema({
  percentualicmsfcp:{
    type: String,
    optional: true
  },
...
Transportadores.attachSchema(Schema.transportadorSchema);
